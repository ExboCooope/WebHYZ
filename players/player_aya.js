/**
 * Created by Exbo on 2017/6/24.
 */
function Player_Aya(slot){
    this.player_pos=slot;
}

stgRegisterPlayer("player_aya",Player_Aya);

Player_Aya.pre_load=function(){
...
Player_Aya.prototype.init=function(){
...
Player_Aya.prototype.script=function(){

};

Player_Aya.player_script=function(){
...
Player_Aya.Laser.prototype.script=function(){
    if(this.l<800){
        this.l+=8;
    }
...
Player_Aya.Laser.prototype.on_hit=function(){
